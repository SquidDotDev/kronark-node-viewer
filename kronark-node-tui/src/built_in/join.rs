...
pub fn parse_join(instance: Instance) -> Result<NodeTui, NodeConversionError> {
    ...
    while let Ok(elem) = validate_socket(&instance, sockets.len() - padding, SocketType::IncomingText) {
        ...
        sockets.push(SocketTui{ 
            ...
            additional: Additional::Text { minimum: "0".to_string(), maximum: "".to_string(), valid: "".to_string() },
            connective: true,
        });
    }
